...
public class Q5 {
	...
	public void render(Graphics g){
		...
		g.setColor(Color.white);
		g.drawString("To Sleep", (int)(Game.widthRatio*120), (int)(Game.heightRatio*290));
		g.drawString("Dragon Shore", (int)(Game.widthRatio*120), (int)(Game.heightRatio*440));
		g.drawString("Bed", (int)(Game.widthRatio*120), (int)(Game.heightRatio*590));
		g.drawString("Alabama", (int)(Game.widthRatio*120), (int)(Game.heightRatio*740));
