...
public class Q8 extends Question{
	...
	public void render(Graphics g){
		...
		g.setColor(Color.white);
		g.setColor(Color.white);
		g.drawString("Its Time", (int)(Game.widthRatio*150), (int)(Game.heightRatio*150));
		g.setColor(Color.blue);
		...
		g.setColor(Color.white);
		g.drawString("Imagine Dragons OMG", (int)(Game.widthRatio*120), (int)(Game.heightRatio*290));
		g.drawString("tick tick tick", (int)(Game.widthRatio*120), (int)(Game.heightRatio*440));
		g.drawString("To turn up", (int)(Game.widthRatio*120), (int)(Game.heightRatio*590));
		g.drawString("To Duel", (int)(Game.widthRatio*120), (int)(Game.heightRatio*740));
		timer.render(g);
	}
