...
public class Q10 extends Question{
	...
	public void render(Graphics g){
		...
		g.setColor(Color.white);
		g.drawString("What is Mario's Original Name", (int)(Game.widthRatio*150), (int)(Game.heightRatio*150));
		g.setColor(Color.blue);
		...
		g.setColor(Color.white);
		g.drawString("Luigi", (int)(Game.widthRatio*120), (int)(Game.heightRatio*290));
		g.drawString("Jumpman", (int)(Game.widthRatio*120), (int)(Game.heightRatio*440));
		g.drawString("Stephen Hawking's Middle Name", (int)(Game.widthRatio*120), (int)(Game.heightRatio*590));
		g.drawString("404 Page not found", (int)(Game.widthRatio*120), (int)(Game.heightRatio*740));
		timer.render(g);
	}
