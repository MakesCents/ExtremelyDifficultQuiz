...
public class Q9 extends Question{
	...
	public void render(Graphics g){
		...
		g.setColor(Color.white);
		g.drawString("Lambo and Lilo", (int)(Game.widthRatio*120), (int)(Game.heightRatio*290));
		g.drawString("Mario and Luigi", (int)(Game.widthRatio*120), (int)(Game.heightRatio*440));
		g.drawString("Murray and Bentley", (int)(Game.widthRatio*120), (int)(Game.heightRatio*590));
		g.drawString("Rouge and Shadow", (int)(Game.widthRatio*120), (int)(Game.heightRatio*740));
		timer.render(g);
	}
