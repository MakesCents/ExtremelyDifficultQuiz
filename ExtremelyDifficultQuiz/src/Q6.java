...
public class Q6 extends Question{
	...
	public Q6(Game game, Timer timer){
		this.game = game;
		this.timer = timer;
	}
	...
	public void render(Graphics g){
		...
		g.setColor(Color.white);
		g.drawString("Not enough", (int)(Game.widthRatio*120), (int)(Game.heightRatio*290));
		g.drawString("3 and a half", (int)(Game.widthRatio*120), (int)(Game.heightRatio*440));
		g.drawString("True", (int)(Game.widthRatio*120), (int)(Game.heightRatio*590));
		g.drawString("Eight", (int)(Game.widthRatio*120), (int)(Game.heightRatio*740));
		timer.render(g);
	}
